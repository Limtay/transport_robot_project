...
int main(void)
{
  ...
  HAL_Delay(500); //soft start for osc
  ...
  canTxQueueHandle = osMessageQueueNew (16, sizeof(CAN_Tx_Packet_t), &canTxQueue_attributes);
  ...
  rs485TaskHandle = osThreadNew(Start_rs485, NULL, &rs485Task_attributes);

  /* creation of can1Task */
  can1TaskHandle = osThreadNew(Start_can1, NULL, &can1Task_attributes);

  /* creation of i2c1Task */
  i2c1TaskHandle = osThreadNew(Start_i2c1, NULL, &i2c1Task_attributes);

  /* creation of rcTask */
  rcTaskHandle = osThreadNew(StartRC, NULL, &rcTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LED_G_Pin LED_R_Pin RS485_DIR_Pin */
  GPIO_InitStruct.Pin = LED_G_Pin|LED_R_Pin|RS485_DIR_Pin;
...
/* USER CODE BEGIN Header_Start_can1 */
/**
* @brief Function implementing the can1Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_can1 */
void Start_can1(void *argument)
{
  /* USER CODE BEGIN Start_can1 */
  RD_TASK_CAN1();
  /* USER CODE END Start_can1 */
}

/* USER CODE BEGIN Header_Start_i2c1 */
/**
* @brief Function implementing the i2c1Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_i2c1 */
void Start_i2c1(void *argument)
{
  /* USER CODE BEGIN Start_i2c1 */
  /* Infinite loop */
  RD_TASK_I2C1();
  /* USER CODE END Start_i2c1 */
}
